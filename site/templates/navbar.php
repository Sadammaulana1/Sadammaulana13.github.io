  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo APP_URL; ?>">
        <img src="<?php echo APP_URL; ?>/assets/images/download.png">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <?php if (isset($_SESSION['user'])) { ?>
          ...
          <li class="hidden-xs"><a href="<?php echo APP_URL.'dashboard/paper/add'; ?>" class="btn btn-primary navbar-btn navbar-btn-upload"><span class="glyphicon glyphicon-plus"></span> UPLOAD</a></li>
          <li class="dropdown">
